...
void main() {
  group('ReactiveStateCallback', () {
    test('should update value and execute callback with setState', () {
      int callbackValue = 0;
      final state3 = ReactiveStateCallback<int>(0, onStateChange: (newValue) {
    ...
    test('should maintain singleton instance', () {
      final state1 = ReactiveStateCallback<int>(0);
      final state2 = ReactiveStateCallback<int>(1);
      expect(state1.value, 0);
      expect(state2.value, 1);
    });

    test('should reset value to default with resetState', () {
      final state = ReactiveStateCallback<int>(0);
      state.setState(10);
      state.resetState();
